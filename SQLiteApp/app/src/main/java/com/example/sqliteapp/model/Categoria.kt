...
class Categoria(context: Context?) {
    ...
    companion object {
        ...
        // nombre de los campos de la tabla categoria
        val COL_ID = "idcategoria"
        val COL_NOMBRE = "nombre"

        //sentencia SQL para crear la table
    ...
    fun insertValuesDefault() {
        ...
        // verificamos si existen registros precargados
        val columns = arrayOf(COL_ID, COL_NOMBRE)
        var cursor: Cursor? = db?.query(TABLE_NAME_CATEGORIA, columns, null, null, null, null, null)
